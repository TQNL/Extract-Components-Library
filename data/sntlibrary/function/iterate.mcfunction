...
execute if score #snt_lib_dq_count get_components_library matches 0 run function sntlibrary:list with storage get_components:extract handling.dq
...
function sntlibrary:iterate with storage get_components:extract handling
